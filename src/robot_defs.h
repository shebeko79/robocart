...
constexpr float UP_SPEED_CORRECTION = 0.002;
constexpr float DOWN_SPEED_CORRECTION = 0.03;
constexpr float BREAK_MAX_SPEED_DIFF = 1.1;
constexpr float BREAK_MAX_SPEED_DIFF_WITH_ACCELERATION = 0.7;
constexpr float KICK_PWM_CORRECTION = 0.05;
